					...
					<div class="row">
						<div class="col">
							<div class="header_content d-flex flex-row align-items-center justify-content-start">
								<div class="logo" style = "padding-right:30px"><a href="index.php">AriqPerpus.ID</a></div>
								<!-- <?php
									...
									<div class="col">
										<div class="home_slider_content" data-animation-in="fadeIn" data-animation-out="animate-out fadeOut">
											<div class="home_slider_title">
												<font size="5px">Toko Buku Lengkap</font><br>Tugas Ariq.
											</div>
											<div class="home_slider_subtitle">Selamat Datang di AriqPerpus.ID</div>
									...
									<div class="col">
										<div class="home_slider_content" data-animation-in="fadeIn" data-animation-out="animate-out fadeOut">
											<div class="home_slider_title" style="color:white">
												<font size="5px">Buku Antik</font><br>Tugas Ariq.
											</div>
											<div class="home_slider_subtitle">Hanya di AriqPerpus.ID</div>
				...
				<div class="row icon_box_row">
					...
					<div class="col-lg-4 icon_box_col">
						<div class="icon_box">
							...
							<div class="icon_box_text">
								<p>Gratis Ongkir Area Kota Malang Non Minimum Selama Periode Mei 2075.</p>
							</div>
						</div>
					</div>
					...
					<div class="col-lg-4 icon_box_col">
						<div class="icon_box">
							...
							<div class="icon_box_text">
								<p>Khawatir buku tidak cocok? Jangan khawatir, karena apapun alasannya retur di AriqPerpus.id gratis & mudah!</p>
							</div>
						</div>
					</div>
				...
				<div class="row">
					<div class="col">
						<div class="footer_content d-flex flex-lg-row flex-column align-items-center justify-content-lg-start justify-content-center">
							<div class="footer_logo"><a href="index.php">AriqPerpus.ID</a></div>
							<div class="copyright ml-auto mr-auto">
								<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
								Copyright &copy;<script>
									document.write(new Date().getFullYear());
								</script> All rights reserved | AriqPerpus.id <br>
